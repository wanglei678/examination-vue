<script setup lang='ts'>
  ...
  const init = () => {
    // todo
    console.log(`密卷tab重新加载等级为${props.grade}的数据`);
    chapterList.value = [
      {chapterName: '密卷一', type: 'success'},
      {chapterName: '密卷二', type: 'success'},
      {chapterName: '密卷三', type: 'success'},
      {chapterName: '密卷四', type: 'success'},
      {chapterName: '密卷五', type: 'success'},
      {chapterName: '密卷六', type: 'success'},
      {chapterName: '密卷七', type: 'success'},
      {chapterName: '密卷八', type: 'success'},
      {chapterName: '密卷九', type: 'success'},
      {chapterName: '密卷十', type: 'success'},
      {chapterName: '密卷十一', type: 'success'},
      {chapterName: '密卷十二', type: 'success'},
      {chapterName: '密卷十三', type: 'success'},
      {chapterName: '密卷十四', type: 'success'},
      {chapterName: '密卷十五', type: 'success'},
      {chapterName: '密卷十六', type: 'success'},
      {chapterName: '密卷十七', type: 'success'},
      {chapterName: '密卷十八', type: 'success'},
      {chapterName: '密卷十九', type: 'success'},
      {chapterName: '密卷二十', type: 'success'},
      {chapterName: '密卷二十一', type: 'success'}
    ]
    questionList.value = [
...
<template>
  <div v-loading="loading">
    <el-button @click="addChapterDiaVisval = true" class="mb-10" type="primary">新增密卷</el-button>
